...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::post('getLoanDetailFromLoanReport', 'ApiController@getLoanDetailFromLoanReport');
    Route::post('updateTrackLocation', 'ApiController@updateTrackLocation');
});

//route for mobile apis
Route::group(['prefix' => 'super_admin'], function () {
    Route::get('/', 'SuperAdminController@getAdmins');
    Route::get('admin', 'SuperAdminController@getAdmins');
    Route::get('addadmin', 'SuperAdminController@addAdmin');
    Route::post('saveadmin', 'SuperAdminController@saveAdmin');
    Route::get('{id}/delete', 'SuperAdminController@delete');
    Route::get('{id}/active', 'SuperAdminController@active');
    Route::get('{id}/deactive', 'SuperAdminController@deactive');
    Route::get('plans', 'SuperAdminController@plans');
    Route::get('createplan', 'SuperAdminController@createPlan');
...
Route::get('admin_register', 'HomeController@adminRegister');
Route::get('otp_validation', 'HomeController@otpVerify');
Route::get('plan_pay', 'HomeController@palnPay');

Route::get('logout', 'HomeController@logout');
Route::post('login', 'HomeController@processLogin');
Route::post('register', 'HomeController@register');
Route::post('verifyotp', 'HomeController@confirmOTP');
Route::post('payplan', 'PaymentController@payWithpaypal');
...
//route for base
Route::group(['prefix' => 'baseuser'], function () {
    Route::get('data', 'BaseController@index');
...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::get('collector/data', 'UserController@collectors');
    Route::get('collector/create', 'UserController@createCollector');
    ...
    Route::any('gpsMap', 'UserController@getgpsmap');
    //manage permissions
...
Route::group(['prefix' => 'loan'], function () {
    ...
    Route::post('update_penalty_status', 'LoanController@updatepenaltystatus');
    ...
    Route::post('transaction/sendwhatsapp', 'LoanController@sendWhatsappReceipt');
