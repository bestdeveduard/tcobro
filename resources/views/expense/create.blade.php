...
<div class="card">
  <div class="card-body">
    <div class="panel-heading">
      <h2 class="panel-title">{{trans_choice('general.add',1)}} {{trans_choice('general.expense',1)}}</h2>
    ...
    <div class="panel-body">
      <div class="form-group">
        {!! Form::label('expense_type_id',trans_choice('general.type',1),array('class'=>' control-label')) !!}
      ...
      <div class="form-group">
        ...
        {!! Form::text('date',null, array('class' => 'form-control date-picker',
        'placeholder'=>"",'required'=>'required')) !!}
      </div>
      <div class="form-group">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="form-line">
                ...
                {!! Form::text('recur_start_date',date("Y-m-d"), array('class' => 'form-control
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="form-line">
                ...
                {!! Form::text('recur_end_date',null, array('class' => 'form-control
