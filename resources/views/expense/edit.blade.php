...
<div class="card">
  <div class="card-body">
    <div class="panel-heading">
      <h2 class="panel-title">{{trans_choice('general.edit',1)}} {{trans_choice('general.expense',1)}}</h2>
    ...
    <div class="panel-body">
      <div class="form-group">
        {!! Form::label('expense_type_id',trans_choice('general.expense',1).'
      ...
      <div class="form-group">
        {!! Form::label('amount',trans_choice('general.expense',1).'
        '.trans_choice('general.amount',1),array('class'=>'')) !!}
        {!! Form::text('amount',$expense->amount, array('class' => 'form-control touchspin',
        'placeholder'=>"",'required'=>'required')) !!}
      </div>
      <div class="form-group">
        {!! Form::label('account_id',trans_choice('general.account',1).'
        '.trans_choice('general.from',1),array('class'=>' control-label')) !!}
      ...
      <div class="form-group">
        ...
        {!! Form::text('date',$expense->date, array('class' => 'form-control date-picker',
        'placeholder'=>"",'required'=>'required')) !!}
      </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="form-line">
                ...
                array('day'=>'Day(s)','week'=>'Week(s)','month'=>'Month(s)','year'=>'Year(s)'),$expense->recur_type,
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="form-line">
                ...
                {!! Form::text('recur_start_date',$expense->recur_start_date, array('class' => 'form-control
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="form-line">
                ...
                {!! Form::text('recur_end_date',$expense->recur_end_date, array('class' => 'form-control
