    ...
    <div class="panel panel-white">
        <div class="panel-body table-responsive no-padding">
            ...
            date_interval_create_from_date_string($period .' '.$request->interest_period. 's')),'Y-m-d')}}</td>
                    ...
                    <td>{{number_format($due_interest,2)}}</td>
                    <!---<td id="fees">0</td>-->
        ...
        <div class="panel-body table-responsive no-padding">
            ...
            <table class="table table-sm">
                ...
                <tr>
                    ...
                    <td>
                        {!! Form::text('due_date['.$count.']',$due_date, array('class' => 'form-control date-picker-schedule','data-date-start-date'=>$request->release_date, 'id'=>"due_date".$count,'readonly'=>"")) !!}
                    </td>
                    <td>
                        {!! Form::text('principal['.$count.']',round($principal,2), array('class' => 'form-control','onkeyup'=>"updatesum()",'onkeypress'=>"return isDecimalKey(this,event)", 'id'=>"principal".$count,'readonly'=>"")) !!}
                    </td>
                    
                    <td>
                        {!! Form::text('interest['.$count.']',round($interest,2), array('class' => 'form-control','onkeyup'=>"updatesum()",'onkeypress'=>"return isDecimalKey(this,event)", 'id'=>"interest".$count,'readonly'=>"")) !!}
                    </td>
                    
                    <td>
                        {!! Form::text('fees['.$count.']','0', array('class' => 'form-control','onkeyup'=>"updatesum()",'onkeypress'=>"return isDecimalKey(this,event)", 'id'=>"fees".$count,'readonly'=>"")) !!}
                    </td>
                    
                    <td>
                        {!! Form::text('penalty['.$count.']','0', array('class' => 'form-control','onkeyup'=>"updatesum()",'onkeypress'=>"return isDecimalKey(this,event)", 'id'=>"penalty".$count,'readonly'=>"")) !!}
                    </td>
