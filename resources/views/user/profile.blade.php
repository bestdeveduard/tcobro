...
<div class="card box box-default">
  <div class="card-body">
    ...
    {!! Form::open(array('url' => 'user/profile', 'method' => 'post','class'=>'form-horizontal form-bordered form-label-stripped',"enctype"
    => "multipart/form-data")) !!}
    ...
    <div class="panel-body">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group row">
            <label class="col-sm-5 col-form-label"><strong>Nombre empresa:</strong></label>
            <div class="col-sm-7">
              {!! Form::text('business_name',$user->business_name,array('class'=>'form-control','required'=>'required')) !!}
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              {!! Form::email('email',$user->email,array('class'=>'form-control', 'readonly','required'=>'required')) !!}
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group row">
            <label class="col-sm-5 col-form-label"><strong>Direccion empresa:</strong></label>
            <div class="col-sm-7">
              {!! Form::text('business_address',$user->business_address,array('class'=>'form-control','required'=>'required')) !!}
            </div>
          </div>
        </div>
      </div>
