...
<div class="card">
  <div class="card-body">
    <div class="panel-heading">
      <h2 class="panel-title">{{trans_choice('general.other_income',1)}} </h2>

      <div class="heading-elements">
        @if(Sentinel::hasAccess('other_income.create'))
        <a href="{{ url('other_income/create') }}" class="btn btn-info btn-sm">{{trans_choice('general.add',1)}}
          {{trans_choice('general.other_income',1)}} </a>
        @endif
      </div>
    </div>
                ...
                <ul class="icons-list">
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li><a href="{{ url('other_income/'.$key->id.'/edit') }}"><i class="fa fa-edit"></i>
                          {{ trans('general.edit') }} </a>
                      </li>
                      @endif
                      @if(Sentinel::hasAccess('other_income.delete'))
                      <li><a href="{{ url('other_income/'.$key->id.'/delete') }}" class="delete"><i
