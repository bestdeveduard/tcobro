...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title">Distribucion por tipo de Prestamos<!--{{trans_choice('general.loan',1)}} {{trans_choice('general.product',2)}} ---></h6>
        ...
        <div class="col-md-6">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title">Resumen de ingresos vs Gastos<!---{{trans_choice('general.income',1)}} {{trans_choice('general.vs',2)}} {{trans_choice('general.expense',2)}}---></h6>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title">Resumen registro de clientes por mes<!---{{trans_choice('general.borrower',1)}} {{trans_choice('general.registration',2)}} ---></h6>
    ...
    <div style="display: none;" class="row">
        <div class="col-md-12">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title">Capital Desembolsado por Mes<!--  {{trans_choice('general.disbursed',1)}} {{trans_choice('general.principal',1)}}--> </h6>
