...
@section('content')
    <div class="panel panel-white">
        ...
        <div class="panel-body hidden-print">
            ...
            <div class="row">
                <div class="col-md-4">
                    {!! Form::label('start_date',trans_choice('general.date',1).' '.trans_choice('general.start',1),array('class'=>'')) !!}
                    {!! Form::text('start_date',$start_date, array('class' => 'form-control date-picker', 'placeholder'=>"",'required'=>'required')) !!}
                </div>
                <div class="col-md-4">
                    {!! Form::label('end_date',trans_choice('general.date',1).' '.trans_choice('general.end',1),array('class'=>'')) !!}
