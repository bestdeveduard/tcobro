        ...
        <div class="panel-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="btn btn-success" role="button" href="{{url('report/loan_report/repayments_report')}}">Abrir <i class="icon-search4"></i> </a>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a class="btn btn-success" role="button" href="{{url('report/loan_report/expected_repayments')}}">Abrir <i class="icon-search4"></i> </a>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><a class="btn btn-success" role="button" href="{{url('report/loan_report/arrears_report')}}">Abrir <i class="icon-search4"></i> </a>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><a class="btn btn-success" role="button" href="{{url('report/loan_report/disbursed_loans')}}">Abrir <i class="icon-search4"></i> </a>
                    </td>
                </tr>
                <!---<tr>
                    <td>
