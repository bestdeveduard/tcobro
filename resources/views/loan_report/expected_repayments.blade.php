            ...
            <table class="table table-bordered table-condensed table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="bg-primary"><center>Capital</center></th>
                        <th class="bg-primary"><center>Interes</center></th>
                        <th class="bg-primary"><center>Ajuste</center></th>
                        <th class="bg-primary"><center>Mora</center></th>
                        <th class="bg-green"><center>Total</center></th>
                    </tr>
                </thead>                
