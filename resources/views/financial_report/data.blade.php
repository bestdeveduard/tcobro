        ...
        <div class="panel-body">
            <table id="" class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td><a class="btn btn-success" role="button" href="{{url('report/financial_report/balance_sheet')}}">Abrir <i class="icon-search4"></i> </a>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><a class="btn btn-success" role="button" href="{{url('report/financial_report/trial_balance')}}">Abrir <i class="icon-search4"></i> </a>
                    </td>
                </tr>
                ...
                <tr class="hidden">
                    ...
                    <td><a class="btn btn-success" role="button" href="{{url('report/financial_report/cash_flow')}}">Abrir <i class="icon-search4"></i> </a>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><a class="btn btn-success" role="button" href="{{url('report/financial_report/income_statement')}}">Abrir <i class="icon-search4"></i> </a>
                    </td>
                </tr>
                <!--<tr>
                    <td>
