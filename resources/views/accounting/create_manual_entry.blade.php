...
<div class="card">
  <div class="card-body">
    <div class="panel-heading">
      <h3 class="panel-title">{{trans_choice('general.add',1)}} {{trans_choice('general.journal',1)}}
        {{trans_choice('general.manual_entry',1)}}</h3>

      <div class="heading-elements">
      </div>
    </div>
    {!! Form::open(array('url' => url('accounting/manual_entry/store'), 'method' => 'post', 'class' =>
    'form-horizontal')) !!}
    <div class="panel-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          {!! Form::text('amount',null, array('class' => 'form-control touchspin', 'placeholder'=>"Ingrese el monto del
      ...
      <div class="form-group">
        ...
        !!}
        <div class="col-sm-5">
          {!! Form::select('credit_account_id',$chart_of_accounts,null, array('class' => 'form-control select2',
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          {!! Form::select('debit_account_id',$chart_of_accounts,null, array('class' => 'form-control select2',
          'placeholder'=>"",'required'=>'')) !!}
        </div>
      </div>
      <div class="form-group">
