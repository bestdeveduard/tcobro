...
<div class="card">
  <div class="card-body">
    <div class="panel-heading">
      <h2 class="panel-title">{{trans_choice('general.add',1)}} {{trans_choice('general.capital',1)}}</h2>
    ...
    <div class="panel-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          {!! Form::text('amount',null, array('class' => 'form-control touchspin', 'placeholder'=>"Number or decimal
