    ...
    <div class="navbar-collapse collapse" id="navbar-mobile">
        <ul class="nav navbar-nav">
            <li class="@if(Request::is('client_dashboard')) active @endif"><a
                        href="{{url('client_dashboard')}}">Informacion general
            ...
            @if(\App\Models\Setting::where('setting_key','allow_client_apply')->first()->setting_value==1)
                <li class="dropdown @if(Request::is('client/application/*')) active @endif">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                       aria-expanded="false">Solicitudes de prestamo
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="{{url('client/application/data')}}">Mis solicitudes</a>
                        </li>
                        <li>
                            <a href="{{url('client/application/create')}}">Nueva solicitud</a>
                        </li>
                    </ul>
                </li>
            @endif
