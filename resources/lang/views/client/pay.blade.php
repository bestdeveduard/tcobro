        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title">Pago de prestamo Online</h6>
                ...
                <div class="panel-body">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            {!! Form::label('amount'," Balance total adeudado",array('class'=>'')) !!}
                        ...
                        <button type="submit" class="btn btn-primary" id="pay">Procesar pago</button>
                        <p><br></p>
                        {!! Form::close() !!}
                    </div>
