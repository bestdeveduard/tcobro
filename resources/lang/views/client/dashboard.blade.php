            ...
            <div class="row">
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="description-block border-right">
                        ...
                        @endif
                        <span class="description-text">Balance adeudado</span>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="description-block">
                        ...
                        @endif
                        <span class="description-text">Proximo pago</span>
                    </div>
                    <!-- /.description-block -->
                </div>
            </div>
        ...
        <div class="col-md-7">
            ...
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title">Resumen de prestamos</h6>
...
<?php
$originalDate_due = $key->release_date;
$newDate = date("d-m-Y", strtotime($originalDate_due));
?>
                                <td>{{$newDate}}</td>
                                ...
                                <td>
                                    ...
                                    @else
                                        ...
                                        @if($key->status=='approved')
                                            <span class="label label-info">Esperando desembolso</span>
                                        @endif
                                ...
                                <td>
                                    <a href="{{ url('client/loan/'.$key->id.'/show') }}"
                                       ...
                                       data-title="{{ trans_choice('general.detail',2) }}">Ver</i>
                                    </a>
                                    @if(\App\Models\Setting::where('setting_key','enable_online_payment')->first()->setting_value==1 && \App\Helpers\GeneralHelper::loan_total_balance($key->id)>0)
                                        <a href="{{ url('client/loan/'.$key->id.'/pay') }}"
                                           ...
                                           data-title="{{ trans('general.pay') }}">Pagar</a>
                                    @endif
                                </td>
        ...
        <div class="col-md-5">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title">Pagos recibidos</h6>
