  ...
  <div class="card-body">
    ...
    <div class="panel-body">
      ...
      <div class="form-group">
        {!! Form::label('amount',trans_choice('general.amount',1).' '." de ".'
      ...
      <div class="form-group">
        {!! Form::label('repayment_method_id',trans_choice('general.method',1).' '." de ".'
        '.trans_choice('general.repayment',1),array('class'=>'col-sm-3 control-label')) !!}
        <div class="col-sm-5">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          {!! Form::text('collection_date',date("Y-m-d"), array('class' => 'form-control date-picker',
