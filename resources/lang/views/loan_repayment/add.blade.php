...
<div class="card panel panel-white">
  <div class="card-body">
    <div class="panel-heading">
      <h2 class="panel-title">{{trans_choice('general.add',1)}} {{trans_choice('general.repayment',1)}}</h2>
    ...
    <form class="form-horizontal">
      <div class="panel-body">
        <div class="form-group">
          ...
          <div class="col-sm-5">
            {!! Form::select('loan_id',$loans,null, array('class' => ' form-control
      ...
      <div class="panel-footer">
        <div class="heading-elements">
          <button type="submit" class="btn btn-primary pull-right"
            id="add_repayment">{{trans_choice('general.next',1)}}</button>
        </div>
      </div>
    </form>
  </div>
