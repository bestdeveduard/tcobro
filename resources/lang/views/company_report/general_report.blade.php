              ...
              <ul class="dropdown-menu dropdown-menu-right">
                ...
                <li>
                  <a href="{{url('report/company_report/products_summary/csv?start_date='.$start_date.'&end_date='.$end_date)}}"
                    target="_blank"><i class="icon-download"></i> {{trans_choice('general.download',1)}}
                    {{trans_choice('general.to',1)}} {{trans_choice('general.csv',1)}}
                  </a>
                </li>
              </ul>
            </div>
      ...
      <div class="card-body">
        <div class="panel-white">
          <div class="panel-heading">
            <h6 class="panel-title">Distribucion por tipo de Prestamos
              <!--{{trans_choice('general.loan',1)}} {{trans_choice('general.product',2)}} --->
            </h6>
  ...
  <div class="col-md-6">
    <div class="card">
      <div class="card-body">
        <div class="panel-white">
          <div class="panel-heading">
            <h6 class="panel-title">Resumen de ingresos vs Gastos
              <!---{{trans_choice('general.income',1)}} {{trans_choice('general.vs',2)}} {{trans_choice('general.expense',2)}}--->
            </h6>
  ...
  <div class="col-md-6">
    <div class="card">
      <div class="card-body">
        <div class="panel-white">
          <div class="panel-heading">
            <h6 class="panel-title">Resumen registro de clientes por mes
              <!---{{trans_choice('general.borrower',1)}} {{trans_choice('general.registration',2)}} --->
            </h6>
  ...
  <div class="col-md-6">
    <div class="card">
      <div class="card-body">
        <div class="panel-white">
          <div class="panel-heading">
            <h6 class="panel-title">Resumen Pagos recibidos vs. Pagos esperados</h6>
  ...
  <div class="card-body">
    <div class="col-md-12">
      <div class="panel panel-white">
        <div class="panel-heading">
          <h6 class="panel-title">Capital Desembolsado por Mes
            <!--  {{trans_choice('general.disbursed',1)}} {{trans_choice('general.principal',1)}}-->
          </h6>
