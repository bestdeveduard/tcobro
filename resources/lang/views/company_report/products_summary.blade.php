...
@section('title')
{{trans_choice('general.product',1)}} {{trans_choice('general.summary',1)}}
@endsection
@section('content')
<div class="card">
  <div class="card-body">
      ...
      <table id="order-listing" class="table">
        ...
        <tbody>
          <?php
                    ...
                    ?>
          @foreach(\App\Models\LoanProduct::where('user_id', Sentinel::getUser()->business_id)->get() as $key)
          <?php
