        ...
        <div class="panel-body">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#whatsapp_templates"
                           data-toggle="tab">{{ trans_choice('general.whatsapp',1) }} {{ trans_choice('general.template',2) }}</a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane" id="general">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                @endif
                                <input type="file" name="client_login_background" id="client_login_background" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="tab-pane" id="sms">
                        ...
                        <div class="form-group">
                            {!! Form::label('whatsapp_enabled',trans('general.whatsapp_enabled'),array('class'=>'col-sm-2 control-label')) !!}

                            <div class="col-sm-10">
                                {!! Form::select('whatsapp_enabled',array('0'=>trans('general.no'), '1'=>trans('general.yes')),\App\Models\Setting::where('setting_key','whatsapp_enabled')->first()->setting_value,array('class'=>'form-control','required'=>'required')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <div class="tab-pane" id="whatsapp_templates">
                        <div class="form-group">
                            {!! Form::label('instance',trans('general.instance'),array('class'=>'col-sm-3 control-label')) !!}
                            <div class="col-sm-9">
                                {!! Form::text('whatsapp_api_url',\App\Models\Setting::where('setting_key','whatsapp_api_url')->first()->setting_value,array('class'=>'form-control')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('whatsapp_token',trans('general.whatsapp_token'),array('class'=>'col-sm-3 control-label')) !!}
                            <div class="col-sm-9">
                                {!! Form::text('whatsapp_token',\App\Models\Setting::where('setting_key','whatsapp_token')->first()->setting_value,array('class'=>'form-control')) !!}
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="form-group">
                            {!! Form::label('payment_received_whatsapp_template',trans('general.payment_received_template'),array('class'=>'col-sm-3 control-label')) !!}
                            <div class="col-sm-9">
                                {!! Form::textarea('payment_received_whatsapp_template',\App\Models\Setting::where('setting_key','payment_received_whatsapp_template')->first()->setting_value,array('class'=>'form-control')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('loan_payment_reminder_whatsapp_template',trans('general.payment_reminder_template'),array('class'=>'col-sm-3 control-label')) !!}
                            <div class="col-sm-9">
                                {!! Form::textarea('loan_payment_reminder_whatsapp_template',\App\Models\Setting::where('setting_key','loan_payment_reminder_whatsapp_template')->first()->setting_value,array('class'=>'form-control')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('missed_payment_whatsapp_template',trans('general.missed_payment_template'),array('class'=>'col-sm-3 control-label')) !!}
                            <div class="col-sm-9">
                                {!! Form::textarea('missed_payment_whatsapp_template',\App\Models\Setting::where('setting_key','missed_payment_whatsapp_template')->first()->setting_value,array('class'=>'form-control ')) !!}
                            </div>
                        </div>
                        <p class="bg-navy disabled color-palette">{{trans_choice('general.loan',2)}}</p>
                        ...
                        <div class="form-group">
                            {!! Form::label('loan_overdue_whatsapp_template',trans('general.loan_overdue_template'),array('class'=>'col-sm-3 control-label')) !!}
                            <div class="col-sm-9">
                                {!! Form::textarea('loan_overdue_whatsapp_template',\App\Models\Setting::where('setting_key','loan_overdue_whatsapp_template')->first()->setting_value,array('class'=>'form-control')) !!}
                            </div>
                        </div>
                    </div>
