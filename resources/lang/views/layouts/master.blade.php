...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/dropzone/dropzone.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/font-awesome/css/all.min.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-bar-rating/bars-1to10.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-bar-rating/bars-horizontal.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-bar-rating/bars-movie.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-bar-rating/bars-pill.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-bar-rating/bars-reversed.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-bar-rating/bars-square.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-bar-rating/bootstrap-stars.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-bar-rating/css-stars.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-bar-rating/examples.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-bar-rating/fontawesome-stars-o.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-bar-rating/fontawesome-stars.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-asColorPicker/css/asColorPicker.min.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/x-editable/bootstrap-editable.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/dropify/dropify.min.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-file-upload/uploadfile.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/jquery-tags-input/jquery.tagsinput.min.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/new_theme/vendors/tempusdominus-bootstrap-4/tempusdominus-bootstrap-4.min.css') }}">-->
...
<!---
<script src="{{ asset('assets/new_theme/vendors/jquery-bar-rating/jquery.barrating.min.js') }}"></script> 
<script src="{{ asset('assets/new_theme/vendors/jquery-asColor/jquery-asColor.min.js') }}"></script> 
<script src="{{ asset('assets/new_theme/vendors/jquery-asGradient/jquery-asGradient.min.js') }}"></script> 
<script src="{{ asset('assets/new_theme/vendors/jquery-asColorPicker/jquery-asColorPicker.min.js') }}"></script> 
<script src="{{ asset('assets/new_theme/vendors/x-editable/bootstrap-editable.min.js') }}"></script> 
<script src="{{ asset('assets/new_theme/vendors/moment/moment.min.js') }}"></script> --->
  </div>
