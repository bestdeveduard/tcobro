          ...
          <table id="order-listing" class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $key->address }}, {{ $key->country->name }}</td>
                <td>{{ $key->phone }}</td>
                <td>{{ $key->mobile }}</td>
                ...
                <center>    
                    ...
                    <a href="{{ url('borrower/'.$key->id.'/delete') }}">
                  ...
                  <ul class="list-group">
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right" role="menu">
                        ...
                        <li>
                            <a href="{{ url('borrower/'.$key->id.'/show') }}"><i class="fa fa-search"></i>Ver perfil</a>
                        </li>
                        @endif
                        
                        @if(Sentinel::hasAccess('borrowers.update'))
                        <li>
                            <a href="{{ url('borrower/'.$key->id.'/edit') }}"><i class="fa fa-edit"></i>Editar</a>
                        </li>
                        @endif
                        
                        @if(Sentinel::hasAccess('borrowers.delete'))
                        <li>
                            <a href="{{ url('borrower/'.$key->id.'/delete') }}" class="delete"><i class="fa fa-trash"></i>Eliminar</a>
                        </li>
                        @endif
