...
class CapitalController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = Capital::where('branch_id', Sentinel::getUser()->business_id)->get();
        $balance = Capital::where('branch_id', Sentinel::getUser()->business_id)->where('type', 'deposit')->sum('amount') - Capital::where('branch_id', Sentinel::getUser()->business_id)->where('type',
    ...
    public function edit($capital)
    {
        ...
        $chart[trans_choice('equity',2)]=$chart_equity;
        $chart[trans_choice('expense',2)]=$chart_expenses;
        return view('capital.edit', compact('chart'));
    }
