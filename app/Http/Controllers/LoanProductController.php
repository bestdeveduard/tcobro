...
class LoanProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        GeneralHelper::audit_trail("Nuevo producto de préstamo creado con ID:" . $loan_product->id);
    ...
    public function update(Request $request, $id)
    {
        ...
        GeneralHelper::audit_trail("Producto de préstamo actualizado con ID:" . $loan_product->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect('loan/loan_product/data');
    }
    ...
    public function delete($id)
    {
        ...
        GeneralHelper::audit_trail("Producto de préstamo eliminado con ID:" . $id);
