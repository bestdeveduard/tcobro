...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        Setting::where('setting_key', 'whatsapp_enabled')->update(['setting_value' => $request->whatsapp_enabled]);

        Setting::where('setting_key', 'payment_received_whatsapp_template')->update(['setting_value' => $request->payment_received_whatsapp_template]);
        Setting::where('setting_key', 'loan_payment_reminder_whatsapp_template')->update(['setting_value' => $request->loan_payment_reminder_whatsapp_template]);
        Setting::where('setting_key', 'missed_payment_whatsapp_template')->update(['setting_value' => $request->missed_payment_whatsapp_template]);
        Setting::where('setting_key', 'loan_overdue_whatsapp_template')->update(['setting_value' => $request->loan_overdue_whatsapp_template]);
        Setting::where('setting_key', 'whatsapp_api_url')->update(['setting_value' => $request->whatsapp_api_url]);
        Setting::where('setting_key', 'whatsapp_token')->update(['setting_value' => $request->whatsapp_token]);
        ...
        if ($request->hasFile('company_logo')) {
            ...
            if ($validator->fails()) {
                ...
                $request->file('company_logo')->move('uploads',
        ...
        if ($request->hasFile('client_login_background')) {
            ...
            if ($validator->fails()) {
                ...
                $request->file('client_login_background')->move('uploads',
